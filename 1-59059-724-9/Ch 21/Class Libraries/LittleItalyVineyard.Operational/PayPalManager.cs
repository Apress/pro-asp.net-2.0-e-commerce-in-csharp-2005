...
namespace LittleItalyVineyard.Operational
{
	public class PayPalManager
	{
		...
		public PayPalManager()
		{
			...
			//set this to the path of your .p12 file (api certificate) on the filesystem
			//String certlocation = @"C:\VS2005 Web Projects\LittleItalyVineyards\Class Libraries\LittleItalyVineyard.Operational\Certs\LittleItalyVineyards.p12";
		...
		public void GetTransactionDetails()
		{
			...
			//GetTransactionDetailsReq GetDetailsReq = new GetTransactionDetailsReq();
			//GetDetailsReq.GetTransactionDetailsRequest = new GetTransactionDetailsRequestType();
			//GetDetailsReq.GetTransactionDetailsRequest.TransactionID = "2GF47217S3480594E";
			//GetDetailsReq.GetTransactionDetailsRequest.Version = "2.0";
	...
	////      'send the request, return response
			//GetTransactionDetailsResponseType GetDetailsRes = new GetTransactionDetailsResponseType();
			//GetDetailsRes = PPInterface.GetTransactionDetails( GetDetailsReq );

			
			
	//        switch ( GetDetailsRes.Ack )
	//        {
	//            case AckCodeType.Success:

						
	//                //TempString.Append( "API response: <b>" + GetDetailsRes.Ack.ToString() +
	//                //"</b><br> Timestamp: <b>" + GetDetailsRes.Timestamp.ToLongTimeString() +
	//                //"</b><br> Version: <b>" + GetDetailsRes.Version.ToString() +
	//                //    //"</b><br><br> ----Details----" +
	//                // "</b><br> Payment Status: <b>" + GetDetailsRes.PaymentTransactionDetails.PaymentInfo.PaymentStatus.ToString() +
	//                // "</b><br> Payment Date: <b>" + GetDetailsRes.PaymentTransactionDetails.PaymentInfo.PaymentDate.ToString() +
	//                // "</b><br> Transaction ID: <b>" + GetDetailsRes.PaymentTransactionDetails.PaymentInfo.TransactionID.ToString() +
	//                // "</b><br> Payment Type: <b>" + GetDetailsRes.PaymentTransactionDetails.PaymentInfo.PaymentType.ToString() +
	//                // "</b><br> Gross: <b>" + GetDetailsRes.PaymentTransactionDetails.PaymentInfo.GrossAmount.Value +
	//                // "</b><br> Fee: <b>" + GetDetailsRes.PaymentTransactionDetails.PaymentInfo.FeeAmount.Value +
	//                // "</b><br> First Name: <b>" + GetDetailsRes.PaymentTransactionDetails.PayerInfo.PayerName.FirstName.ToString() +
	//                // "</b><br> Last Name: <b>" + GetDetailsRes.PaymentTransactionDetails.PayerInfo.PayerName.LastName.ToString() +
	//                // "</b><br> Address1: <b>" + GetDetailsRes.PaymentTransactionDetails.PayerInfo.Address.Street1.ToString() +
	//                // "</b><br> Address2: <b>" + GetDetailsRes.PaymentTransactionDetails.PayerInfo.Address.Street2.ToString() +
	//                // "</b><br> City: <b>" + GetDetailsRes.PaymentTransactionDetails.PayerInfo.Address.CityName.ToString() +
	//                // "</b><br> State: <b>" + GetDetailsRes.PaymentTransactionDetails.PayerInfo.Address.StateOrProvince.ToString() +
	//                // "</b><br> Zip: <b>" + GetDetailsRes.PaymentTransactionDetails.PayerInfo.Address.PostalCode.ToString() +
	//                // "</b><br> Email: <b>" + GetDetailsRes.PaymentTransactionDetails.PayerInfo.Payer.ToString() );
	//                //Response.Write( TempString.ToString() );
	//                break;

	//            case AckCodeType.Failure:
	//                //TempString.Append( "API response: <b>" + GetDetailsRes.Ack.ToString() + "</b><br> Timestamp: <b>" + GetDetailsRes.Timestamp.ToLongTimeString() +
	//                //    //"</b><br> Version: <b>" + RefundResType.Version.ToString +
	//                //    "</b><br> Error code: <b>" + GetDetailsRes.Errors[0].ErrorCode +
	//                //    "</b><br> Short error: <b>" + GetDetailsRes.Errors[0].ShortMessage +
	//                //    "</b><br> Long error: <b>" + GetDetailsRes.Errors[0].LongMessage );
	//                //Response.Write( TempString.ToString() );
	//                break;
